...
web3.personal.unlockAccount("0x42339e31a153db90c4f9af3326fc9c541b18225e", "l@z@r0", 10000);

/*

console.log("Loading contract source code using built-in Node module (FS)...");
// sourceCode = fs.readFileSync('Add.sol').toString();
sourceCode= fs.readFileSync('test.sol',{encoding: 'utf8'}).toString();
